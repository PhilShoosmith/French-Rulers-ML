        ...
        <header className="p-4 border-b border-slate-700 flex justify-between items-center flex-shrink-0">
          <div className="flex items-center gap-4">
            ...
            <h2 id="rag-modal-title" className="text-2xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-purple-500">
              {content?.title ? t('aboutMonarch', { name: content.title }) : t('loading')}
            </h2>
          </div>
          <button 
            onClick={onClose} 
        ...
        <div className="p-6 overflow-y-auto">
          {isLoading ? (
            <div className="flex flex-col justify-center items-center h-48 text-center p-4">
                <p className="text-lg text-slate-300">{t('findingInformation')}</p>
                ...
                <p className="text-slate-400 animate-pulse">{t('pleaseWait')}</p>
            </div>
          ) : (
            <>
